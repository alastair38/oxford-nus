...
<html <?php language_attributes(); ?>>
	...
	<?php wp_body_open(); ?>
		...
		<div id="page-blockhaus" class="flex flex-col">
			...
			<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'blockhaus' ); ?>
			</a>
			...
			<header id="masthead" class="main-header bg-neutral-light-100 md:bg-base top-0 left-0 right-0 z-50 p-3 flex flex-col lg:p-6">
				...
				<div class="flex justify-between items-center">
					...
					<div class="flex items-center gap-2">
						...
						<a class="logo flex gap-2 items-center" aria-label="Home page" rel="home" href="<?php echo esc_url( home_url( '/' ) ); ?>">
