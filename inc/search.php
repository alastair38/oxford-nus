...
function blockhaus_custom_form($placeholder = null, $post_type = null) {
	$form = '<form role="search" method="get" class="search-form w-40 xl:max-w-prose mx-auto text-sm leading-6 flex py-1 px-2 bg-base rounded-full border border-neutral-light-100 focus-within:border-secondary gap-2" action="' . home_url( '/' ) . '">
	<label class="w-full">
